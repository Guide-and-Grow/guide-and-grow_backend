        ...
        <div class="container px-5 py-24 mx-auto">
          ...
          <div class="flex flex-wrap -m-4">
            <div class="lg:w-1/3 sm:w-1/2 p-4">
              <div class="flex relative bg-pur-light">
                <img
                  alt="gallery"
                  class="absolute inset-0  h-full p-5 object-cover object-center img-margin"
                  src={youtubeVideo}
                />
            ...
            <div class="lg:w-1/3 sm:w-1/2 p-4">
              <div class="flex relative bg-pur-light">
                <img
                  alt="gallery"
                  class="absolute inset-0  p-5 h-full object-cover object-center img-margin"
                  src={document}
                />
                <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  <h2 class="tracking-widest text-sm title-font font-medium text-indigo-500 mb-1">
            ...
            <div class="lg:w-1/3 sm:w-1/2 p-4">
              <div class="flex relative bg-pur-light text-center">
                <img
                  alt="gallery"
                  class="absolute inset-0  h-full  p-4 object-cover object-center img-margin"
                  src={interview}
                />
                <div class="px-8 py-10 relative z-10 w-full border-4 border-gray-200 bg-white opacity-0 hover:opacity-100">
                  <h2 class="tracking-widest text-sm title-font font-medium text-indigo-500 mb-1">
