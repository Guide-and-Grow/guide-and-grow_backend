    ...
    <div>
      <header className="text-gray-600 body-font">
        <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
          ...
          <button onClick={()=>{window.location.href="/login"}} className="hover:bg-indigo-600 text-gray-50 inline-flex items-center bg-indigo-500 border-0 py-1 px-3 focus:outline-none hover:bg-gray-200 rounded text-base mt-4 md:mt-0">
            Login
            {/* <svg
              fill="none"
              stroke="currentColor"
